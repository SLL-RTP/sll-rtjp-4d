  ...
  SET X0=%SCHEMADIR%\interactions\GetClinicalChemistryLabOrderOutcomeInteraction\*.xsd
	...
	SET W1=%SCHEMADIR%\.\interactions\GetMicroBiologiLabOrderOutcomeInteraction\GetMicroBiologiLabOrderOutcomeInteraction_1.0_RIVTABP21.wsdl
  SET X1=%SCHEMADIR%\interactions\GetMicroBiologiLabOrderOutcomeInteraction\*.xsd
...
SET NAMESPACE=/namespace:*,Sll.Clinicalprocess.Healthcond.Actoutcome.Schemas.v1
