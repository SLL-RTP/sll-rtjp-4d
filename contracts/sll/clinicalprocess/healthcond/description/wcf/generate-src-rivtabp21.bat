...
SET NAMESPACE=/namespace:*,Sll.Clinicalprocess.Healthcond.Description.Schemas.v1.0
SET SVCUTIL="svcutil.exe"
%SVCUTIL% /language:cs %OUTFILE% %APPCONFIG% %NAMESPACE% %SCHEMAS%

CD wcf
ECHO Generating Service contract .Net Binding interfaces and classes for clinicalprocess:healthcond:description Release 1.0
