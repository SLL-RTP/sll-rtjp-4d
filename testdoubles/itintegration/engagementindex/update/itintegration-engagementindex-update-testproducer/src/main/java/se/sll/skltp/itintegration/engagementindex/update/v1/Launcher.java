...
public class Launcher {
	...
	protected Launcher(String address) throws Exception {
		System.out.println("Starting Update testproducer");
		...
		final Object implementor = new UpdateImpl();
		Endpoint.publish(address, implementor);
	}

	public static void main(String[] args) throws Exception {
        String address = "http://localhost:20001/testproducer/itintegration/engagementindex/Update/1/rivtabp21";
