...
public class Launcher {
	...
	protected Launcher(String address) throws Exception {
		System.out.println("Starting GetLabResults testproducer");
		...
		final Object implementor = new GetClinicalChemistryLabOrderOutcomeImpl();
		Endpoint.publish(address, implementor);
	}

	public static void main(String[] args) throws Exception {
		new Launcher("http://localhost:20001/testproducer/GetClinicalChemistryLabOrderOutcome/1/rivtabp21");
