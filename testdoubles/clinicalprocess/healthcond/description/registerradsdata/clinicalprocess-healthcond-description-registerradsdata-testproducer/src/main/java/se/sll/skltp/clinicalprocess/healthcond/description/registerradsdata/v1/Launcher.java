 ...
 */
package se.sll.skltp.clinicalprocess.healthcond.description.registerradsdata.v1;
...
public class Launcher {
	...
	protected Launcher(String address) throws Exception {
		System.out.println("Starting RegisterRaDSData testproducer");
		...
		final Object implementor = new RegisterRaDSDataImpl();
		Endpoint.publish(address, implementor);
	}

	public static void main(String[] args) throws Exception {
        String address = "http://localhost:20001/testproducer/RegisterRaDSData/1/rivtabp21";
