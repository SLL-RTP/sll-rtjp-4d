...
public class Launcher {
	...
	protected Launcher(String address) throws Exception {
		System.out.println("Starting GetRaDSData testproducer");
		...
		final Object implementor = new GetRaDSDataImpl();
		Endpoint.publish(address, implementor);
	}

	public static void main(String[] args) throws Exception {
		String address = "http://localhost:20001/testproducer/GetRaDSData/1/rivtabp21";
		new Launcher(address);
		System.out
				.println("Producer ready and listening on address " + address);
