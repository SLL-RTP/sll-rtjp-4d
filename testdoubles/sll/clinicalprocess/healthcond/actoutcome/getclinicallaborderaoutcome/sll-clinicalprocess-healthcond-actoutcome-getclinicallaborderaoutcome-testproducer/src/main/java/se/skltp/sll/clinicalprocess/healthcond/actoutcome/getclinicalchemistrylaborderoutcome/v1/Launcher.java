...
public class Launcher {
    ...
    protected Launcher(String address) throws Exception {
        System.out
                .println("Starting GetClinicalChemistryLabOrderOutcome testproducer");
    ...
    public static void main(String[] args) throws Exception {
        String address = "http://localhost:20001/testproducer/sll/clinicalprocess/healthcond/actoutcome/GetClinicalChemistryLabOrderOutcome/1/rivtabp21";
