/**
 * Copyright 2013 Stockholm L�ns Landsting
 *
...
public class Launcher {
    ...
    protected Launcher(String address) throws Exception {
        System.out.println("Starting GetMicroBiologiLabOrderOutcome testproducer");
        ...
        final Object implementor = new GetMicroBiologiLabOrderOutcomeImpl();
        Endpoint.publish(address, implementor);
    }

    public static void main(String[] args) throws Exception {
        String address = "http://localhost:20001/testproducer/sll/clinicalprocess/healthcond/actoutcome/GetMicroBiologiLabOrderOutcome/1/rivtabp21";
