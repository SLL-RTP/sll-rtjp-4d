...
public class Launcher {
	...
	protected Launcher(String address) throws Exception {
		System.out.println("Starting GetRaPatientData testproducer");
		...
		final Object implementor = new GetRaPatientDataImpl();
		Endpoint.publish(address, implementor);
	}

	public static void main(String[] args) throws Exception {
        String address = "http://localhost:20001/testproducer/sll/clinicalprocess/healthcond/description/GetRaPatientData/1/rivtabp21";
