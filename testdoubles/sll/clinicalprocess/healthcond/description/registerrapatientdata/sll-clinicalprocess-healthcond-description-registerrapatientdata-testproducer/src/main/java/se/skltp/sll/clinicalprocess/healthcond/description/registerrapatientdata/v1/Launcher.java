 ...
 */
package se.skltp.sll.clinicalprocess.healthcond.description.registerrapatientdata.v1;
...
public class Launcher {
	...
	protected Launcher(String address) throws Exception {
		System.out.println("Starting RegisterRaPatientData testproducer");
		...
		final Object implementor = new RegisterRaPatientDataImpl();
		Endpoint.publish(address, implementor);
	}

	public static void main(String[] args) throws Exception {
        String address = "http://localhost:20001/testproducer/sll/clinicalprocess/healthcond/description/RegisterRaPatientData/1/rivtabp21";
